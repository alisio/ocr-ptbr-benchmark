...
output_dir = "/Users/alisio/temp/ocr_results"
...
print(f"Imagem manuscrita gerada! ({os.path.getsize(os.path.join(output_dir, 'documento_manuscrito.png'))} bytes)")
print(f"Ground truth ({len(GROUND_TRUTH)} chars, {len(GROUND_TRUTH.split())} palavras):")
print(GROUND_TRUTH)
